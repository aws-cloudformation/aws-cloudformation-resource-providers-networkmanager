...
public class DeleteHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final DeleteSiteResponse deleteSiteResponse = DeleteSiteResponse.builder()
                .site(buildSite())
                .build();
        doReturn(deleteSiteResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DeleteSiteRequest.class), any());
