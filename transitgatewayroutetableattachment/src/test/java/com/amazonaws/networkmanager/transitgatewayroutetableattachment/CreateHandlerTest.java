...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createTransitGatewayRouteTableAttachment(any(CreateTransitGatewayRouteTableAttachmentRequest.class)))
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createTransitGatewayRouteTableAttachment(any(CreateTransitGatewayRouteTableAttachmentRequest.class))).thenThrow(exception);
    ...
    public void handleRequest_AttachmentStateFailedExpectError() {
        ResourceModel model = MOCKS.model(PeeringState.AVAILABLE.toString());
        when(proxyClient.client().createTransitGatewayRouteTableAttachment(any(CreateTransitGatewayRouteTableAttachmentRequest.class)))
                .thenReturn(MOCKS.createResponse(AttachmentState.CREATING.toString()));
        when(proxyClient.client().getTransitGatewayRouteTableAttachment(any(GetTransitGatewayRouteTableAttachmentRequest.class)))
