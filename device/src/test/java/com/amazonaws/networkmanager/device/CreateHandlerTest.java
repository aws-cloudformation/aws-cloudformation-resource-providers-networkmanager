...
public class CreateHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final CreateDeviceResponse createDeviceResponse = CreateDeviceResponse.builder()
                .device(buildDevice())
                .build();
        doReturn(createDeviceResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(CreateDeviceRequest.class), any());
