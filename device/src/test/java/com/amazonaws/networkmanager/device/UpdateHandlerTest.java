...
public class UpdateHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final UpdateDeviceResponse updateDeviceResponse = UpdateDeviceResponse.builder()
                .device(buildSimpleDevice())
                .build();
        ...
        doReturn(updateDeviceResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(UpdateDeviceRequest.class), any());
