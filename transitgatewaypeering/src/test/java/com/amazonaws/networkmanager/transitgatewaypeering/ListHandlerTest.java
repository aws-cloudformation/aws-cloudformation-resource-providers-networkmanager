...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void tear_down() {
        verify(sdkClient, atLeastOnce()).listPeerings(any(ListPeeringsRequest.class));
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().listPeerings(any(ListPeeringsRequest.class)))
        ...
        assertThat(response.getResourceModels().get(0).getPeeringId()).isEqualTo(expectedResult.getPeeringId());
    ...
    public void handleRequest_Error() {
        ...
        AwsErrorDetails errorDetails = AwsErrorDetails.builder()
                .errorMessage("Something went wrong").errorCode("ServerInternal").build();
        AwsServiceException exception = AwsServiceException.builder().awsErrorDetails(errorDetails).build();
        when(proxyClient.client().listPeerings(any(ListPeeringsRequest.class))).thenThrow(exception);
