...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createConnectAttachment(any(CreateConnectAttachmentRequest.class)))
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createConnectAttachment(any(CreateConnectAttachmentRequest.class))).thenThrow(exception);
