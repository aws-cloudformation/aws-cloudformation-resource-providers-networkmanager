...
public class Delete {
    ...
    private DeleteAttachmentResponse makeServiceCall(DeleteAttachmentRequest awsRequest, ProxyClient<NetworkManagerClient> client) {
    ...
    private ProgressEvent<ResourceModel, CallbackContext>  handleError(DeleteAttachmentRequest awsRequest, Exception exception,
