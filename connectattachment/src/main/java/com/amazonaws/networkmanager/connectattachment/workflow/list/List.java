package com.amazonaws.networkmanager.connectattachment.workflow.list;
...
public class List {
    ...
    private java.util.List<ResourceModel> translateResponseToModel(ListAttachmentsResponse awsResponse) {
        return streamOfOrEmpty(awsResponse.attachments())
                .filter(attachment -> attachment.attachmentTypeAsString().equals(AttachmentType.CONNECT.toString()))
