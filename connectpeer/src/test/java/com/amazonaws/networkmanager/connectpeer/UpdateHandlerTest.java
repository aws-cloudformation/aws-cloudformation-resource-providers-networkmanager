...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_CreateTagsSuccess() {
        ...
        when(proxyClient.client().getConnectPeer(any(GetConnectPeerRequest.class)))
                ...
                .thenReturn(MOCKS.describeResponse(newTags, ConnectPeerState.AVAILABLE.toString())) //Get Delete Tags Read
                .thenReturn(MOCKS.describeResponse(newTags, ConnectPeerState.AVAILABLE.toString())); //Final Read
    ...
    public void handleRequest_ChangeTagsAndDescriptionSuccess() {
        ...
        when(proxyClient.client().getConnectPeer(any(GetConnectPeerRequest.class)))
                ...
                .thenReturn(MOCKS.describeResponse(tags2, ConnectPeerState.AVAILABLE.toString())); //Get Final model
        when(proxyClient.client().tagResource(any(TagResourceRequest.class))).thenReturn(MOCKS.tagResourceResponse());
        when(proxyClient.client().untagResource(any(UntagResourceRequest.class))).thenReturn(MOCKS.untagResourceResponse());
