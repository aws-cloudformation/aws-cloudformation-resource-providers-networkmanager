...
public class UpdateHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final UpdateLinkResponse updateLinkResponse = UpdateLinkResponse.builder()
                .link(buildSimpleLink())
                .build();
        ...
        doReturn(updateLinkResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(UpdateLinkRequest.class), any());
