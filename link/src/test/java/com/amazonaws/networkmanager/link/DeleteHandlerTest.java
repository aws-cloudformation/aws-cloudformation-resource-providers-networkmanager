...
public class DeleteHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final DeleteLinkResponse deleteLinkResponse = DeleteLinkResponse.builder()
                .link(buildLink())
                .build();
        doReturn(deleteLinkResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DeleteLinkRequest.class), any());
