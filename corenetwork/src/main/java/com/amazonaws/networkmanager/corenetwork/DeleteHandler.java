...
import com.amazonaws.networkmanager.corenetwork.workflow.delete.Delete;
import com.amazonaws.networkmanager.corenetwork.workflow.delete.ValidCurrentStateCheck;
...
public class DeleteHandler extends BaseHandlerStd {
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
                ...
                .then(_progress -> ProgressEvent.defaultSuccessHandler(null));
    }
}
