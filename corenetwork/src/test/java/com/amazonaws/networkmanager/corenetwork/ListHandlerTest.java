...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void tear_down() {
        verify(sdkClient, atLeastOnce()).listCoreNetworks(any(ListCoreNetworksRequest.class));
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().listCoreNetworks(any(ListCoreNetworksRequest.class)))
        ...
        assertThat(response.getResourceModels().get(0).getCoreNetworkId()).isEqualTo(expectedResult.getCoreNetworkId());
        assertThat(response.getResourceModels().get(0).getCoreNetworkArn()).isEqualTo(expectedResult.getCoreNetworkArn());
        assertThat(response.getResourceModels().get(0).getDescription()).isEqualTo(expectedResult.getDescription());
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().listCoreNetworks(any(ListCoreNetworksRequest.class))).thenThrow(exception);
