...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        when(proxyClient.client().deleteCoreNetwork(any(DeleteCoreNetworkRequest.class))).thenReturn(MOCKS.deleteResponse());
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().deleteCoreNetwork(any(DeleteCoreNetworkRequest.class))).thenThrow(exception);
        when(proxyClient.client().getCoreNetwork(any(GetCoreNetworkRequest.class)))
                .thenReturn(MOCKS.describeResponse());
    ...
    public void handleRequest_NotFound() {
        ...
        when(proxyClient.client().getCoreNetwork(any(GetCoreNetworkRequest.class))).thenThrow(exception);
