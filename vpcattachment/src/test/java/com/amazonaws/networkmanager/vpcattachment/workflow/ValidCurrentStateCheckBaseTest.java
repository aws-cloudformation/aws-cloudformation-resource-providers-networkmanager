...
public class ValidCurrentStateCheckBaseTest extends AbstractTestBase {
    ...
    public void tear_down() {
        verify(sdkClient, atLeastOnce()).getVpcAttachment(any(GetVpcAttachmentRequest.class));
    ...
    public void validForValidAvailableState() {
        ...
        when(proxyClient.client().getVpcAttachment(any(GetVpcAttachmentRequest.class))).thenReturn(MOCKS.describeResponse(tags));
    ...
    public void failedForValidAvailableState() {
        final List<Tag> tags = new ArrayList<>();
        tags.add(MOCKS.getCfnTag());
        ResourceModel model = MOCKS.model(tags, AttachmentState.DELETING.toString());
        CallbackContext context =  new CallbackContext();
    ...
    public void throwError() {
        ...
        ResourceModel model = MOCKS.model(tags);
        CallbackContext context =  new CallbackContext();
        when(proxyClient.client().getVpcAttachment(any(GetVpcAttachmentRequest.class))).thenThrow(ResourceNotFoundException.class);
