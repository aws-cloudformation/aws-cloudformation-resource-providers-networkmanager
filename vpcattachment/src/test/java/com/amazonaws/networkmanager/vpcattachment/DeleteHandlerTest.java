...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().getVpcAttachment(any(GetVpcAttachmentRequest.class))).thenReturn(MOCKS.describeResponse())
    ...
    public void handleRequest_NotFound() {
        ...
        when(proxyClient.client().getVpcAttachment(any(GetVpcAttachmentRequest.class))).thenThrow(exception);
