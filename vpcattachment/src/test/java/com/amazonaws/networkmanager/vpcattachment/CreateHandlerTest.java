...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createVpcAttachment(any(CreateVpcAttachmentRequest.class)))
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createVpcAttachment(any(CreateVpcAttachmentRequest.class))).thenThrow(exception);
