...
import com.amazonaws.networkmanager.sitetositevpnattachment.ProposedSegmentChange;
...
public class UtilsTest extends AbstractTestBase {
    ...
    public void sdkTagsToCfnTags() {
        ...
        final List<com.amazonaws.networkmanager.sitetositevpnattachment.Tag> cfnTags = Utils.sdkTagsToCfnTags(sdkTags);
    ...
    public void sdkTagsToCfnTagsWhenNull() {
        final List<com.amazonaws.networkmanager.sitetositevpnattachment.Tag> cfnTags = Utils.sdkTagsToCfnTags(null);
    ...
    public void difference1() {
        com.amazonaws.networkmanager.sitetositevpnattachment.Tag sharedTag = MOCKS.getCfnTag();
        final List<com.amazonaws.networkmanager.sitetositevpnattachment.Tag> tags1 = new ArrayList<>();
        tags1.add(sharedTag);
        tags1.add(MOCKS.getCfnTag());
        final List<com.amazonaws.networkmanager.sitetositevpnattachment.Tag> tags2 = new ArrayList<>();
        tags2.add(sharedTag);
    ...
    public void sdkSegmentChangeToCfnSegmentChange() {
        ...
        software.amazon.awssdk.services.networkmanager.model.ProposedSegmentChange sdkProposedSegmentChange =
                MOCKS.getMockSdkProposedSegmentChange(sdkTags);
