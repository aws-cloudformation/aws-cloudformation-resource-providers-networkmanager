...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ResourceModel model = MOCKS.model(AttachmentState.PENDING_ATTACHMENT_ACCEPTANCE.toString());
        when(proxyClient.client().createSiteToSiteVpnAttachment(any(CreateSiteToSiteVpnAttachmentRequest.class)))
                .thenReturn(MOCKS.createResponse(AttachmentState.PENDING_ATTACHMENT_ACCEPTANCE.toString()));
        when(proxyClient.client().getSiteToSiteVpnAttachment(any(GetSiteToSiteVpnAttachmentRequest.class)))
                .thenReturn(MOCKS.describeResponse(AttachmentState.PENDING_ATTACHMENT_ACCEPTANCE.toString()));
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createSiteToSiteVpnAttachment(any(CreateSiteToSiteVpnAttachmentRequest.class))).thenThrow(exception);
