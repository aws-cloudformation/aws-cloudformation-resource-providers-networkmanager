...
public class CreateHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final AssociateCustomerGatewayResponse associationCustomerGatewayResponse = AssociateCustomerGatewayResponse.builder()
                .customerGatewayAssociation(buildCustomerGatewayAssociation())
                .build();
        doReturn(associationCustomerGatewayResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(AssociateCustomerGatewayRequest.class), any());
