...
public class DeleteHandlerTest extends TestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final DisassociateCustomerGatewayResponse disassociateCustomerGatewayResponse = DisassociateCustomerGatewayResponse.builder()
                .customerGatewayAssociation(buildCustomerGatewayAssociation())
                .build();
        doReturn(disassociateCustomerGatewayResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DisassociateCustomerGatewayRequest.class), any());
